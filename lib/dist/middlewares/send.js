...
const json_1 = require("../transformers/json");
class SendMiddleware {
     ...
     */
    checkAcceptHeader(acceptHeader, xmlAcceptHeaders) {
    ...
    constructor(options) {
        ...
        this.jsonTransformer = new json_1.default({
            transformJsonKeys: this.options.transformJsonKeys
        });
    }
}
exports.default = SendMiddleware;
