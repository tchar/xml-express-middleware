...
function parseOptions(options) {
    ...
    if (options != null) {
        ...
        options.sendName = options.sendName || 'send';
            ...
            let send = function (data) {
                if (typeof data === 'object') {
                    if (checkAcceptHeader(req.headers['accept'], options.xmlAcceptHeaders)) {
                        ...
                        trueSend(res.send).apply(res, [transformXml(data, {
                            transformXmlKey: options.transformXmlKey,
                            noXmlTransform: options.noXmlTransform
                        }, resOptionsclear)]);
                    } else {
